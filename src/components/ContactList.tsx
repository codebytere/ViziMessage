...
class ContactList extends React.Component<IContactListProps, { contacts: IContactInfo[] }> {
    ...
    return (
      <Panel color='info'>
        ...
        <Panel.Block className='contact-search'>
          <input type='text' className='input is-medium' placeholder='Search' onChange={this.filterContacts}/>
        </Panel.Block>
